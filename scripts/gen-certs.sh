...
# This script is used to generate the CA certificate, the client certificate and the client key.
# The CA certificate is used to verify the client certificate.
# The client certificate is used to connect to the apiserver.
# The client key is used to encrypt the client certificate.
...
readonly PROJ_DOMAIN="k8s-ai.com"
